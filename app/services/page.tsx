    ...
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
        {servicesList.map((s, i) => (
          <div key={i} className="bg-white border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
        <div className="bg-primary rounded-2xl p-8 text-white space-y-4">
          ...
          <p className="text-primary-foreground/80">Can&apos;t manage work, life, and class at the same time? We connect you with an expert who handles your entire course.</p>
          <Link href="/services/take-my-online-class">
            <Button variant="secondary" className="gap-2 bg-white text-primary hover:bg-gray-100">Learn More <ArrowRight className="h-4 w-4" /></Button>
          </Link>
        </div>
        <div className="bg-gray-800 rounded-2xl p-8 text-white space-y-4">
          <h2 className="text-2xl font-bold">Take My Online Exam</h2>
          <p className="text-gray-300">Our exam specialists will complete your online exam on your behalf and aim for the grade you need.</p>
          <Link href="/services/take-my-online-exam">
            <Button variant="outline" className="gap-2 border-white text-white hover:bg-white hover:text-gray-800">Learn More <ArrowRight className="h-4 w-4" /></Button>
          </Link>
        </div>
      </div>
      ...
      {servicesData.length > 0 && (
        <div>
          <h2 className="text-2xl font-bold mb-6 text-center">Order a Service Now</h2>
